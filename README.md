...
### Jidou Navi
A crowdsourced discovery app for Japan's unique vending machines — co-built with a development partner, covering design, backend, API, and mobile deployment.  
🔒 Currently in closed testing on Google Play — public launch is the next step (iOS TBD).  
